...
const projects = [
  ...
  },
  {
    ...
    role: 'Full-Stack Developer',
    techStack: 'Ruby on Rails | PostgreSQL | ReactJS',
  ...
  },
  {
    ...
    role: 'Full-Stack Developer',
    techStack: 'Ruby on Rails | PostgreSQL | TensorFlow',
                        ...
                        <div className="p-8 relative z-10">
                          <div className="mb-6">
                            ...
                            <div className="space-y-2 text-gray-600">
                              <p className="font-medium">Role: {project.role}</p>
                              <p className="font-medium">Tech Stack: {project.techStack}</p>
                            </div>
                          </div>
        ...
        <div className="container mx-auto px-6 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-1 text-sm text-gray-500">
            ...
            <div className="flex items-center space-x-4 ml-4">
              <a href="https://github.com/codeAbstract" className="hover:text-gray-900 transition-colors">
              ...
              <a href="https://linkedin.com/in/nsaguda/" className="hover:text-gray-900 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </a>
              <a href="https://instagram.com/_icode.new" className="hover:text-gray-900 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
